...
ProductMapListNewResponse productMapListResponseFromJson(String str) =>
    ProductMapListNewResponse.fromJson(json.decode(str));
String productMapListResponseToJson(ProductMapListNewResponse data) =>
    json.encode(data.toJson());

class ProductMapListNewResponse {
  ...
  ProductMapListNewResponse.fromJson(dynamic json) {
  ...
  num? _skip;
  num? _limit;
  ProductMapListNewResponse copyWith({
    List<Products>? products,
    num? total,
    num? skip,
    num? limit,
...
class Dimensions {
  ...
  num? _height;
  num? _depth;
  Dimensions copyWith({num? width, num? height, num? depth}) => Dimensions(
    width: width ?? _width,
