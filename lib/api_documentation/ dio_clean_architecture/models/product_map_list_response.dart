...
ProductMapListResponse productMapListResponseFromJson(String str) =>
    ProductMapListResponse.fromJson(json.decode(str));
String productMapListResponseToJson(ProductMapListResponse data) =>
    json.encode(data.toJson());

class ProductMapListResponse {
  ...
  ProductMapListResponse.fromJson(dynamic json) {
  ...
  num? _skip;
  num? _limit;
  ProductMapListResponse copyWith({
    List<Products>? products,
    num? total,
    num? skip,
    num? limit,
