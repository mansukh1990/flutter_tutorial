class GetObjectProductResponse {
  List<Products>? products;
  int? total;
  int? skip;
  int? limit;

  GetObjectProductResponse({this.products, this.total, this.skip, this.limit});

  GetObjectProductResponse.fromJson(Map<String, dynamic> json) {
